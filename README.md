...
Terraform Provider for the *test* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=test&utm_campaign=terraform)
...
* [test_message](docs/data-sources/message.md)
...
1. Execute `go build` to construct a binary called `terraform-provider-test`
...
provider_installation {
  ...
  dev_overrides {
      "registry.terraform.io/speakeasy/test" = "<PATH>"
  }
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=test&utm_campaign=terraform)
